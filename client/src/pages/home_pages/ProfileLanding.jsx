        ...
        <div className="card">
          <div className="card-body">
            <div className="d-flex flex-column align-items-center text-center">
              ...
              <div className="mt-3">
                <h4> {user ? user.fname  + '- ' + user.last_names : "update you full  names"}</h4>
                <p className="text-secondary mb-1">student</p>
                <p className="text-muted font-size-sm">{user.reg_nums}</p>
                <button className="btn btn-primary">Contact Admin</button>
                <button className="btn btn-outline-primary">Inbox</button>
              </div>
            </div>
          </div>
        </div>
        <div className="card mt-3">
          <ul className="list-group list-group-flush">
            <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
              ...
              <span className="text-secondary"> {user &&  user.campuss !== "null" ? user.campuss : "update your course"}</span>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
              <h6 className="mb-0">Faculty</h6>
              <span className="text-secondary">{user  && user.colleges !== "null" ?user.colleges:"update college" }</span>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
              <h6 className="mb-0">Course</h6>
              <span className="text-secondary"> {user && user.courses !== "null" ? user.courses : "update your course"}</span>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
              <h6 className="mb-0">Discipline</h6>
              <span className="text-secondary">{user &&  user.disciplines !== "null "? user.disciplines :" update discipline details"}</span>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
              <h6 className="mb-0">Year of Enrollment</h6>
              <span className="text-secondary">{user && user.enroll_date  ? user.enroll_dates :" update enrollment details"}</span>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
              <h6 className="mb-0">year of graduation</h6>
              <span className="text-secondary">{user && user.finish_dates ? user.finish_dates :" update year of details"}</span>
            </li>
        ...
        <div className="card mb-3">
          <div className="card-body">
            ...
            <div className="row">
              ...
              <div className="col-sm-9 text-secondary">
               {user && user.genders ? user.genders :"updated your gender"}
              </div>
            </div>
            <hr />
            <div className="row">
        ...
        <div className="row gutters-sm">
          <div className="col-sm-6 mb-3">
            <div className="card h-100">
              <div className="card-body">
                <h6 className="d-flex align-items-center mb-3"><i className="material-icons text-info mr-2">Skills</i>status</h6>
                <small>Campus</small>
          ...
          <div className="col-sm-6 mb-3">
            <div className="card h-100">
              <div className="card-body">
                <h6 className="d-flex align-items-center mb-3"><i className="material-icons text-info mr-2">Resumes</i>docs</h6>
